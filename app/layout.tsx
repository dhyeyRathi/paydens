...
export default function RootLayout({ children }: LayoutProps<"/">) {
  return (
    ...
    >
      <body className="min-h-full  overflow-x-hidden flex flex-col items-center justify-center  pt-[80px] sm:pt-[140px] min-[480]:pt-[120px] md:pt-[180px] lg:pt-[200px]  bg-white ">
        <Navbar />
