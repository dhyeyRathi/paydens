    ...
    return (
        <div id={id} className={`${className} min-w-[220px] sm:min-w-[350px] h-[420px] sm:h-[700px] relative overflow-hidden rounded-2xl paydens-shadow`}>
            ...
            <div className='h-full w-full bg-background p-3 sm:p-6 flex flex-col gap-1 sm:gap-2 items-start justify-start'>
                <h1 className='text-sm sm:text-lg lg:text-3xl font-[600] '>{name}</h1>
                ...
                <h1 className='flex group gap-4 hover:gap-6 justify-start items-center cursor-pointer text-sm w-full text-link hover:text-primary font-bold transition-all duration-200 ease-in-out pb-2'>View Full Profile <em className={`${styles.hr} `}>
